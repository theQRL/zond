...
git_repository(
    ...
    patch_cmds = ["cmake -DBUILD_GO=ON", "make", "rm goqrllib/goqrllib/*.cxx", "rm goqrllib/dilithium/*.cxx", "rm goqrllib/kyber/*.cxx", "bazel run //:gazelle", "rm tests/golang/misc/*.bazel", "rm tests/golang/tests/*.bazel"]
)
